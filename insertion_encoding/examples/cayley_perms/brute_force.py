...
m = 3
print(f"Cayley permutations length {m} in Av({basis})")
for cperm in Av(basis_patterns).generate_cperms(m):
    print(cperm)

print(f"Number of Cayley permutations length {m} in Av({basis})")
print(len(Av(basis_patterns).generate_cperms(m)))

# Prints the number of Cayley permutations of size 0 to n in the class Av{basis_patterns}
n = 7
print(f"Number of Cayley permutations in the class Av({basis}):")
...
print(
    f"Is the Cayley permutation {cperm} in the class Av({basis}):",
